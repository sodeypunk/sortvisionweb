...
<div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
  ...
  <ul class="nav navbar-nav navbar-right collapse" id="navbar-icons">
    ...
    <li class="user <?php if(strtolower($uri_segment_2)=='register') { echo 'open'; } ?>"> <a href="<?php echo site_url('auth/register');?>"><span>Create Account</span></a></li>
    <li class="user dropdown <?php if(strtolower($uri_segment_2)=='sendactivation' || strtolower($uri_segment_2)=='forgotpassword' || strtolower($uri_segment_2)=='retrieveusername') { echo 'active'; } ?>"> <a class="dropdown-toggle" data-toggle="dropdown"><span>Login help</span> <i class="caret"></i> </a>
      <ul class="dropdown-menu dropdown-menu-right icons-right">
        <li><a class="<?php if(strtolower($uri_segment_2)=='retrieveusername') { echo 'active'; } ?>" href="<?php echo site_url('auth/retrieveusername');?>">Retrieve username</a></li>
        <li><a class="<?php if(strtolower($uri_segment_2)=='forgotpassword') { echo 'active'; } ?>" href="<?php echo site_url('auth/forgotpassword');?>">Retrieve password</a></li>
        <li><a class="<?php if(strtolower($uri_segment_2)=='sendactivation') { echo 'active'; } ?>" href="<?php echo site_url('auth/sendactivation');?>">Resend activation link</a></li>
      </ul>
    </li>
  </ul>
  <?php } else { ?>
