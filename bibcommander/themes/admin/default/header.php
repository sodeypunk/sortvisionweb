...
<div class="navbar navbar-inverse" role="navigation">
  <div class="navbar-header">
    ...
    <a class="navbar-brand" href="<?php echo base_url();?>"><img src="<?php echo base_url("assets/img/SORTVISION_100x43.png") ; ?>"></a></div>
  <?php } else { ?>
  <a class="navbar-brand" href="<?php echo base_url();?>"><img src="<?php echo base_url("assets/img/SORTVISION_100x43.png") ; ?>"></a> <a class="sidebar-toggle"><i class="icon-paragraph-justify2"></i></a>
